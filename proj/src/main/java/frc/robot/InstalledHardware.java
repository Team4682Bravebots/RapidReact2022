...
public class InstalledHardware
{
    ...
    public static final boolean pressureReliefSwitchInstalled = true;
    ...
    public static final boolean forwardBallStorageBeamBreakSensorInstalled = true;
    public static final boolean rearBallStorageBeamBreakSensorInstalled = true;

    // Angle Arms Related Hardware
    public static final boolean angleArmsToJawsCylinderSolenoidPneumaticsInstalled = true;
    public static final boolean angleArmsToChassisCylinderSolenoidPneumaticsInstalled = true;
}
